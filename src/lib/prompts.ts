...
- [마무리 3~5초] 여운 남기는 한 줄 + 가벼운 팔로우 유도 한 번만(가볍게). '저장하세요' 식 저장 유도, '풀영상/자세한 건 영상에서' 식 다른 영상 유도, 정보 제공·면책 안내는 대본에 넣지 않는다.
...
- 맨 끝 imageRef=null 인 마무리 1개: 여운 한 줄 + 가벼운 팔로우 유도 한 번만(가볍게). '저장하세요' 식 저장 유도, '풀영상/자세한 건 영상에서' 식 다른 영상 유도, 정보 제공·면책 안내는 넣지 않는다.
