...
- [마무리 3~5초] 부모가 곱씹게 되는, 혹은 힘이 되는 한마디로 깔끔하게 끝낸다. '구독'·'좋아요'·'팔로우' 같은 채널 행동 유도(유튜브에 '팔로우'는 없다), '저장하세요' 식 저장 유도, '풀영상/자세한 건 영상에서' 식 다른 영상 유도, 정보 제공·면책 안내는 대본에 넣지 않는다.
...
4) 목적 부합 자가 평가: 이 채널은 발달장애(발달지연) 아이를 키우는 부모에게 '정말 유용한 정보'를 제공하는 곳이다. 완성한 대본이 그 목적에 맞게 분명하고 정확한 정보 한 덩어리를 전달하는지 마지막으로 평가하고, 부족하면 정보 밀도를 끌어올린 뒤 확정한다.
...
- 맨 끝 imageRef=null 인 마무리 1개: 부모가 곱씹게 되는, 혹은 힘이 되는 한마디로 깔끔하게 끝낸다. '구독'·'좋아요'·'팔로우' 같은 채널 행동 유도(유튜브에 '팔로우'는 없다), '저장하세요' 식 저장 유도, '풀영상' 식 다른 영상 유도, 정보 제공·면책 안내는 넣지 않는다.
